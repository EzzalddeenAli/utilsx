package org.kingtec.utils.slidr;
...
public final class Slidr {
     ...
     * @return a {@link org.kingtec.utils.slidr.model.SlidrInterface} that allows
     * the user to lock/unlock the sliding mechanism for whatever purpose.
     */
    @NonNull
    ...
    /**
     * Attach a slider mechanism to an activity based on the passed {@link org.kingtec.utils.slidr.model.SlidrConfig}
     *
     * @param activity the activity to attach the slider to
