...
public abstract class MarkerButtonIcon extends CompoundToggleButton {
    ...
    protected View rl_icon;
    protected int mMarkerColor;
    protected boolean mRadioStyle;
    protected boolean wIcon=false;
    public MarkerButtonIcon(Context context) {
        this(context, null);
    }

    public MarkerButtonIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
