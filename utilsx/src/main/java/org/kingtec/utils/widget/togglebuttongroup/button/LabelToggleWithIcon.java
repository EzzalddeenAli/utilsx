...
public class LabelToggleWithIcon extends MarkerButtonIcon implements ToggleButton {
    private static final String LOG_TAG = LabelToggleWithIcon.class.getSimpleName();
    ...
    public LabelToggleWithIcon(Context context) {
        this(context, null);
    }

    public LabelToggleWithIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void setChecked(boolean checked) {
        ...
        if (checked) {
            if(!wIcon) {
                iv_icon.setImageResource(R.drawable.ic_checked);
                mIvBg.setVisibility(VISIBLE);
            } mIvBg.startAnimation(mCheckAnimation);
            mTextColorAnimator.start();
        } else {
            if(!wIcon) {
                iv_icon.setImageResource(R.drawable.ic_unchecked);
                mIvBg.setVisibility(VISIBLE);
            } mIvBg.setVisibility(VISIBLE);
