...
//            mIvBg.setVisibility(VISIBLE);
            mLLBg.setBackgroundResource(R.drawable.bg_label_checked);
            mTvText.setTextColor(getCheckedTextColor());
            mTextColorAnimator.start();
        } else {
//            mIvBg.setVisibility(VISIBLE);
            mLLBg.setBackgroundResource(R.drawable.bg_label_unchecked);

            mTvText.setTextColor(getDefaultTextColor());
