...
public abstract class ItemsListNewAdapter<SingleItem extends ListItemType> extends RecyclerView.Adapter<ItemViewHolder>
    ...
    public ItemsListNewAdapter(List<SingleItem> mList, @LayoutRes int res, ListAdapterListener<SingleItem> listener) {
        this.mList = mList;
